...
/* Indica que cuando es necesite una clase, se busque en el paquete
 * "android.app". En este caso encuantra la clase Activity.*/
import android.app.*;
/* Indica que cuando es necesite una clase, se busque en el paquete
 * "android.os". En este caso encuantra la clase Bundle.*/
import android.os.*;
...
public class MainActivity extends Activity 
{
  ...
  protected void onCreate(Bundle savedInstanceState)
     ...
     * este caso se llama main. Si alguno de los archivos res
